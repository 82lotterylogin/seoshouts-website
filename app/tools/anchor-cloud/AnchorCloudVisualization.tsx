...
export default function AnchorCloudVisualization({ anchors, insights }: Props) {
  ...
  const generateWordCloud = () => {
    ...
    sortedAnchors.forEach((anchor, index) => {
      const fontSize = getFontSize(anchor.count, maxCount, 12, 36) // Reduced max size
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h3 className="text-2xl font-bold text-gray-900">Interactive Anchor Text Cloud</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm"
          />
          <select
            value={minCount}
      ...
      <div className="bg-gray-50 rounded-xl p-4">
        <div className="text-sm font-medium text-gray-700 mb-2">Frequency Legend:</div>
        <div className="flex flex-wrap gap-4 text-sm">
          ...
          <div className="flex items-center">
            <div className="w-4 h-4 bg-[#059669] rounded mr-2"></div>
          ...
          <div className="flex items-center">
            <div className="w-4 h-4 bg-[#9333EA] rounded mr-2"></div>
      ...
      <div ref={containerRef} className="relative w-full">
        <div className="bg-white rounded-2xl border-2 border-gray-200 p-4 min-h-[400px] flex items-center justify-center">
          {cloudItems.length > 0 ? (
            <canvas
              ref={canvasRef}
        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex justify-between items-start p-6 border-b border-gray-200">
              <h4 className="text-xl font-semibold text-gray-900">Anchor Text Details</h4>
              <button
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm font-medium text-gray-600 mb-2">Anchor Text</div>
                  <div className="font-semibold text-gray-900 break-words text-lg">{selectedAnchor.text}</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm font-medium text-gray-600 mb-2">Usage Count</div>
                  <div className="font-semibold text-primary text-xl">{selectedAnchor.count} times</div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <div className="max-h-48 overflow-y-auto space-y-2">
                  {selectedAnchor.pages.map((page, index) => (
                    <div key={index} className="text-sm font-mono text-gray-700 break-all bg-white p-2 rounded border">
                      {page}
                    </div>
                  ))}
                </div>
              ...
              {/* Usage Statistics */}
              <div className="bg-gradient-to-r from-primary/5 to-blue-50 rounded-xl p-4">
                <div className="text-sm font-medium text-gray-800 mb-2">Usage Statistics</div>
