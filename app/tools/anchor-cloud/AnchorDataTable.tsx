...
export default function AnchorDataTable({ anchors, insights }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Anchor Text Data Table</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          <input
            ...
            className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm min-w-64"
          />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 text-center">
          <div className="text-sm text-blue-700 font-medium">Single Use</div>
          <div className="text-2xl font-bold text-blue-900">{insights.singleUsageAnchors}</div>
          <div className="text-xs text-blue-600">
            {((insights.singleUsageAnchors / insights.totalUniqueAnchors) * 100).toFixed(1)}% of total
          </div>
        </div>
        <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-4 text-center">
          <div className="text-sm text-green-700 font-medium">Multiple Use</div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl p-4 text-center">
          <div className="text-sm text-purple-700 font-medium">Top Anchor</div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl p-4 text-center">
          <div className="text-sm text-orange-700 font-medium">Avg per Page</div>
          <div className="text-2xl font-bold text-orange-900">{insights.averageLinksPerPage}</div>
              ...
              <tr>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-400">{getSortIcon('text')}</span>
                  </div>
                </th>
                <th
                  className="px-6 py-4 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100 transition-colors"
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-400">{getSortIcon('href')}</span>
                  </div>
                </th>
                <th
                  className="px-6 py-4 text-left text-sm font-semibold text-gray-900 cursor-pointer hover:bg-gray-100 transition-colors"
                ...
                >
                  <div className="flex items-center space-x-2">
                    <span>Pages</span>
                    <span className="text-gray-400">{getSortIcon('pages')}</span>
                  </div>
                </th>
                    ...
                    <div className="max-w-xs">
                      ...
                      {anchor.text.length > 60 && (
                        <div className="text-xs text-gray-500 mt-1">
                          Full text: {anchor.text}
                        </div>
                      )}
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getFrequencyBadge(anchor.count)}`}>
