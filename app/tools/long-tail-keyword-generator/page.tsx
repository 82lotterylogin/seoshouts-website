  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        ...
        {"@type":"Question","name":"Is this long tail keyword tool really free?","acceptedAnswer":{"@type":"Answer","text":"Yes, completely free. No account, no credit card, no daily paywall on core features. Volume data, intent classification, and CSV export, the features most tools reserve for paid plans, are included for every user."}},
        ...
        {"@type":"Question","name":"Do you provide search volume data?","acceptedAnswer":{"@type":"Answer","text":"Yes. Every generated keyword includes an estimated monthly search volume plus a competition level, so you can filter out zero-volume phrases before committing content to them."}},
