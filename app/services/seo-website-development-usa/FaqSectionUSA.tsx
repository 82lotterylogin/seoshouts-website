...
const categorizedFaqs = {
  general: [
    ...
    },
    {
      ...
      answer: "Yes! All our websites are designed with mobile-first in mind. With a majority of internet traffic coming from mobile devices, we ensure that your US-focused website is responsive, loads quickly, and provides an optimal experience across all screen sizes and devices."
    },
    {
      question: 'How do you ensure that my website ranks well on Google?',
      answer: "Our SEO website development process includes optimizing your site for critical SEO factors like page speed, core web vitals, structured data (schema markup), and internal linking. We also ensure your content is optimized for both user intent and Google's algorithms to help you rank higher for relevant search queries in US markets."
    },
    {
      question: 'Will the website be optimized for local SEO and location-based searches?',
      answer: 'Absolutely. We focus on local SEO optimization, which is crucial for American businesses targeting customers in specific geographic locations. From integrating location-based keywords to optimizing your Google Business Profile and creating location-specific landing pages, we ensure that your website ranks well for relevant local searches in the United States.'
    }
  ],
  technical: [
    {
      question: 'How do you optimize websites for Core Web Vitals and speed?',
      answer: "We build lightweight pages, compress media, preload critical CSS, and use clean code. Our goal: a Lighthouse score of 90+ and <2.5s LCP — even on slower connections across the US."
    },
    {
    ...
    },
    {
      ...
      answer: "Every site we create is fully responsive and optimized for mobile speed. With over 60% of US traffic on smartphones, this is essential for SEO success."
    },
    {
  ...
  pricing: [
    ...
    },
    {
      ...
      answer: "Yes! We provide post-launch support to ensure your American business website continues to perform well. This includes monitoring SEO performance, troubleshooting any issues, and offering guidance on how to update or add new content to maintain your rankings."
    },
    {
      question: 'What payment options are available?',
      answer: "We accept all major credit cards (Visa, MasterCard, American Express), PayPal, Stripe, and wire transfers for US-based clients."
    }
  ],
  content: [
    {
    ...
    },
    {
      ...
      answer: 'We can assist with SEO-optimized content creation, including writing compelling copy with targeted keywords, meta descriptions, and headlines for American audiences. However, if you already have content, we can work with your existing material to optimize it for both SEO and user engagement.'
    },
    {
      question: 'Will my website be built with future SEO updates in mind?',
      answer: "Absolutely. We build websites with scalability and future-proofing in mind, ensuring they remain optimized even as SEO trends and Google algorithms evolve. Whether it's adopting new SEO techniques or preparing for major algorithm changes, your American business website will be ready for the future."
    }
  ]
}
