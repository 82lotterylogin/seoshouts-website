  ...
  return (
    <section id="core-web-vitals-check" className="section svc-section">
      <style>{`
        ...
        .wd-cwc-panels { display: flex; flex-direction: column; gap: 1px; background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.09); }
        .wd-cwc-panel { background: var(--ink); padding: 1.5rem 1.75rem; }
        .wd-cwc-panel-hd { display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.25rem; padding-bottom: 1rem; border-bottom: 1px solid rgba(255,255,255,0.07); }
        .wd-cwc-panel-left { display: flex; align-items: center; gap: 12px; }
        .wd-cwc-panel-icon { width: 34px; height: 34px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.09); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.65); flex-shrink: 0; }
        ...
        .wd-cwc-metric { display: flex; flex-direction: column; align-items: center; gap: 4px; padding: 0 8px; border-right: 1px solid rgba(255,255,255,0.06); }
