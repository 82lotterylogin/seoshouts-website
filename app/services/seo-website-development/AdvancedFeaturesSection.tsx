...
const advancedFeatures = {
  'Technical SEO Excellence': {
    ...
    features: [
      ...
      { icon: 'globe',   name: 'Hreflang Implementation',    desc: 'For multi-language Indian markets based on years of international SEO' },
  ...
  'Performance Optimisation': {
    ...
    features: [
      ...
      { icon: 'database', name: 'Browser Caching',                desc: 'Cache strategies proven effective across Indian hosting' },
      { icon: 'globe',    name: 'CDN Integration',                desc: 'Optimised for Indian cities based on years of data' },
  ...
  'User Experience Enhancements': {
    ...
    icon: 'layout',
    features: [
      { icon: 'compass',      name: 'Intuitive Navigation',          desc: 'Designed for Indian user behaviour patterns' },
      { icon: 'target',       name: 'Call-to-Action Placement',      desc: 'Based on conversion data from years of testing' },
      { icon: 'trending',     name: 'Conversion-Focused Design',     desc: 'Proven effective across Indian markets' },
      { icon: 'shield',       name: 'Accessibility Compliance',      desc: 'WCAG 2.1 AA with SEO considerations' },
      { icon: 'monitor',      name: 'Cross-Browser Compatibility',   desc: 'Tested across popular Indian browsers' },
      { icon: 'smartphone',   name: 'PWA Capabilities',              desc: 'Enhanced mobile experience for Indian users' },
    ],
  },
}
  ...
  return (
    <section className="section features-section">
      <style>{`
        ...
        .wd-adv-feat-tabs { border-right: 1px solid var(--line); }
        ...
        .wd-adv-feat-tab.wd-adv-on .wd-adv-feat-tab-icon { background: var(--blue); }
        ...
        .wd-adv-feat-item { background: #fff; padding: 1.25rem; display: flex; gap: 12px; align-items: flex-start; }
        .wd-adv-feat-item:hover { background: var(--gray-1); }
      ...
      <div className="section-container">
        <div className="s-header">
          <div className="eyebrow">Advanced Capabilities</div>
