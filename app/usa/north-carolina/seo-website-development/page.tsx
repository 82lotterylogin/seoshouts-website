...
export const metadata: Metadata = {
  title: 'SEO Website Development North Carolina | Fast, Search-Ready Sites That Rank',
  description: "Partner with North Carolina's leading SEO Website Development Company building lightning-fast, search-optimized sites that rank, convert, and scale. Get a free performance check today.",
  metadataBase: new URL('https://seoshouts.com'),
  alternates: {
    canonical: 'https://seoshouts.com/usa/north-carolina/seo-website-development/',
  },
  openGraph: {
    title: 'SEO Website Development Company in North Carolina – High-Performance Websites That Rank',
    ...
    url: 'https://seoshouts.com/usa/north-carolina/seo-website-development/',
    siteName: 'SEO Shouts',
    images: [
      {
        url: 'https://seoshouts.com/images/services/north-carolina-seo-website-development-service.jpg',
        width: 1200,
        height: 630,
        alt: 'North Carolina SEO Website Development Services by SEOShouts',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'North Carolina SEO Website Development – Build High-Performance Sites',
    description: '98% client satisfaction. 10+ years delivering optimized websites for North Carolina businesses.',
    site: '@seo_shouts',
    creator: '@seo_shouts',
    images: ['https://seoshouts.com/images/services/north-carolina-seo-website-development-service.jpg'],
  },
  robots: {
    index: true,
    follow: true,
...
// FAQ data for North Carolina market

export default async function NorthCarolinaSEOWebsiteDevelopmentPage() {
  // Fetch latest blog posts from database
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 3,
                "name": "North Carolina",
                "item": "https://seoshouts.com/usa/north-carolina/seo-website-development/"
              }
            ]
          })
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "SEOShouts - North Carolina SEO Website Development",
            "description": "Expert SEO website development services for North Carolina businesses with 6+ years of proven expertise serving North Carolina and the competitive North Carolina market.",
            "url": "https://seoshouts.com/usa/north-carolina/seo-website-development/",
            "areaServed": {
              "@type": "State",
              "name": "North Carolina",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
            "name": "North Carolina SEO Website Development Services",
            "description": "Professional SEO website development for North Carolina businesses including mobile-first design, AI optimization, Core Web Vitals enhancement, and enterprise-grade technical SEO.",
            "image": "https://seoshouts.com/images/services/north-carolina-seo-website-development-service.jpg",
            "provider": {
              "@type": "Organization",
              "name": "SEOShouts"
            },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "SEO Website Development North Carolina",
            "description": "Partner with North Carolina's leading SEO Website Development Company building lightning-fast, search-optimized sites that rank, convert, and scale.",
            "url": "https://seoshouts.com/usa/north-carolina/seo-website-development/",
            "inLanguage": "en-US",
            "isPartOf": {
              "@type": "WebSite",
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! All our websites are designed with mobile-first in mind. With a majority of internet traffic coming from mobile devices, we ensure that your North Carolina-focused website is responsive, loads quickly, and provides an optimal experience across all screen sizes and devices."
                }
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes! We provide post-launch support to ensure your North Carolina business website continues to perform well. This includes monitoring SEO performance, troubleshooting any issues, and offering guidance on how to update or add new content to maintain your rankings."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "We can assist with SEO-optimized content creation, including writing compelling copy with targeted keywords, meta descriptions, and headlines for North Carolina audiences. However, if you already have content, we can work with your existing material to optimize it for both SEO and user engagement."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Absolutely. We build websites with scalability and future-proofing in mind, ensuring they remain optimized even as SEO trends and Google algorithms evolve. Whether it's adopting new SEO techniques or preparing for major algorithm changes, your North Carolina business website will be ready for the future."
                }
              }
            ]
          })
      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-12 space-y-6">
                ...
                <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto">
                  Technically optimized, lightning-fast websites for North Carolina businesses ready to dominate search results from day one
                </p>
              </div>
        ...
        {/* Why North Carolina Businesses Choose Our SEO Development Services */}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full mb-6">
                  ...
                  <span className="text-sm font-semibold text-blue-700 uppercase tracking-wide">North Carolina's Choice</span>
                </div>
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                  Why North Carolina Businesses Choose<br />
              ...
              <div className="max-w-4xl mx-auto text-center">
                <div className="space-y-6 text-lg sm:text-xl text-slate-700 leading-relaxed mb-12">
                  <p>
                    In North Carolina's hyper-competitive digital landscape—from <strong className="text-slate-900">North Carolina startups</strong> to <strong className="text-slate-900">North Carolina e-commerce brands</strong> and <strong className="text-slate-900">North Carolina service providers</strong>—your website is your most critical marketing asset.
                  </p>
                  <p>
                ...
                <div className="grid sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
                  ...
                  <div className="flex flex-col items-center text-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-slate-900 mb-1">North Carolina Focused</p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                  What Makes Us North Carolina's<br />
                  <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-3 text-slate-700">
                      ...
                      <span>Programmatic, scalable content structures for North Carolina cities/services with entity optimization for AI/SGE</span>
                    </li>
                    <li className="flex items-start gap-3 text-slate-700">
                      <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mt-12 text-center">
                <p className="text-slate-600">
                  <strong>Note:</strong> All prices transparently listed with no hidden fees. Professional invoicing for North Carolina business accounting.
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-lg text-blue-100 leading-relaxed">
                    Meet the dedicated professionals behind your North Carolina SEO success. Our team combines technical expertise with deep market knowledge to build websites that rank and convert.
                  </p>
                </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  We follow a battle-tested methodology for <strong>SEO friendly web development</strong> that ensures your North Carolina business launches with maximum search visibility.
                </p>
              </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3 text-slate-700">
                          ...
                          Comprehensive keyword research targeting North Carolina search intent and user behavior
                        </li>
                        <li className="flex items-start gap-3 text-slate-700">
                          <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                          </svg>
                          Competitive gap analysis across your specific North Carolina market segments
                        </li>
                        <li className="flex items-start gap-3 text-slate-700">
                          <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                ...
                <div className="relative bg-white border border-slate-200 rounded-2xl p-8 hover:border-indigo-300 hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-600 font-semibold">Professional Development by North Carolina-Focused Teams</p>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-start gap-3 text-slate-700">
                          ...
                          LocalBusiness schema implementation with precise North Carolina geo-coordinates
                        </li>
                        <li className="flex items-start gap-3 text-slate-700">
                          <svg className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
        ...
        {/* North Carolina Cities Section - Accordion Design */}
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="max-w-6xl mx-auto text-center">
              <h2 className="text-3xl sm:text-5xl font-bold text-white mb-6 leading-tight">
                Ready to Launch Your North Carolina Business with Our Expert SEO Website Developers?
              </h2>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
                Don't settle for a website that just looks good. Partner with North Carolina's specialist <strong className="text-white">SEO web development company</strong> that delivers measurable results.
              </p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="flex gap-4 text-left">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm sm:text-base text-blue-100 leading-relaxed">We analyze your current situation, discuss your North Carolina market goals, and outline a custom SEO development roadmap.</p>
                    </div>
                  </div>
                  <div className="flex gap-4 text-left">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
                ...
                >
                  🎯 Get Your Expert North Carolina SEO Consultation
                  <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </a>
              ...
              <div className="flex flex-wrap justify-center gap-6 text-white">
                <div className="flex items-center gap-2">
                  ...
                  <span>Free North Carolina Market Audit</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                  </svg>
                  <span>North Carolina Expertise</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
