...
const bronzeFeatures = [
  ...
  "Google Core Web Vitals optimization (tested across Pennsylvania device ecosystems)",
  "SEO-friendly web development using strategies refined through years of testing",
  "Mobile-first responsive design optimized for Pennsylvania user behavior patterns",
...
const goldFeatures = [
  ...
  "Up to 10 pages with comprehensive SEO strategy tailored to Pennsylvania market dynamics",
  ...
  "Pennsylvania-focused blog setup optimized for local search and featured snippets",
...
const platinumFeatures = [
  ...
  "Custom-built online store with conversion rate optimization strategies proven across Pennsylvania markets",
  ...
  "Payment gateway integration (Stripe, PayPal) with PCI compliance and Pennsylvania tax handling",
  "Inventory management system with real-time stock tracking and automated alerts",
  "Order management dashboard with Pennsylvania shipping integration and tracking",
    ...
    <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0 pt-4">
      <div className="flex lg:grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto min-w-max lg:min-w-0">
        ...
        <PackageCard
          ...
          price="$100"
          description="Pennsylvania startups, solopreneurs, consultants, and small business owners requiring a results-driven online presence."
        ...
        <PackageCard
          ...
          price="$199"
          description="Growing Pennsylvania businesses, agencies, and professionals who need dynamic content with proven SEO strategies."
        ...
        <PackageCard
          ...
          price="$299"
          description="Pennsylvania retailers and eCommerce businesses requiring enterprise-grade online stores with conversion-focused SEO."
