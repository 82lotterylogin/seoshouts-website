...
const bronzeFeatures = [
  ...
  "Google Core Web Vitals optimization (tested across North Dakota device ecosystems)",
  "SEO-friendly web development using strategies refined through years of testing",
  "Mobile-first responsive design optimized for North Dakota user behavior patterns",
...
const goldFeatures = [
  ...
  "Up to 10 pages with comprehensive SEO strategy tailored to North Dakota market dynamics",
  ...
  "North Dakota-focused blog setup optimized for local search and featured snippets",
...
const platinumFeatures = [
  ...
  "Custom-built online store with conversion rate optimization strategies proven across North Dakota markets",
  ...
  "Payment gateway integration (Stripe, PayPal) with PCI compliance and North Dakota tax handling",
  "Inventory management system with real-time stock tracking and automated alerts",
  "Order management dashboard with North Dakota shipping integration and tracking",
    ...
    <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0 pt-4">
      <div className="flex lg:grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto min-w-max lg:min-w-0">
        ...
        <PackageCard
          ...
          price="$100"
          description="North Dakota startups, solopreneurs, consultants, and small business owners requiring a results-driven online presence."
        ...
        <PackageCard
          ...
          price="$199"
          description="Growing North Dakota businesses, agencies, and professionals who need dynamic content with proven SEO strategies."
        ...
        <PackageCard
          ...
          price="$299"
          description="North Dakota retailers and eCommerce businesses requiring enterprise-grade online stores with conversion-focused SEO."
