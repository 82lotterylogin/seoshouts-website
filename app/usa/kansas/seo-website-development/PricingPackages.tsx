...
const bronzeFeatures = [
  ...
  "Google Core Web Vitals optimization (tested across Kansas device ecosystems)",
  "SEO-friendly web development using strategies refined through years of testing",
  "Mobile-first responsive design optimized for Kansas user behavior patterns",
...
const goldFeatures = [
  ...
  "Up to 10 pages with comprehensive SEO strategy tailored to Kansas market dynamics",
  ...
  "Kansas-focused blog setup optimized for local search and featured snippets",
...
const platinumFeatures = [
  ...
  "Custom-built online store with conversion rate optimization strategies proven across Kansas markets",
  ...
  "Payment gateway integration (Stripe, PayPal) with PCI compliance and Kansas tax handling",
  "Inventory management system with real-time stock tracking and automated alerts",
  "Order management dashboard with Kansas shipping integration and tracking",
    ...
    <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0 pt-4">
      <div className="flex lg:grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto min-w-max lg:min-w-0">
        ...
        <PackageCard
          ...
          price="$100"
          description="Kansas startups, solopreneurs, consultants, and small business owners requiring a results-driven online presence."
        ...
        <PackageCard
          ...
          price="$199"
          description="Growing Kansas businesses, agencies, and professionals who need dynamic content with proven SEO strategies."
        ...
        <PackageCard
          ...
          price="$299"
          description="Kansas retailers and eCommerce businesses requiring enterprise-grade online stores with conversion-focused SEO."
